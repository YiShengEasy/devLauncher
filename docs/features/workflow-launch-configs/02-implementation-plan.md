...
- [x] Extend the TypeScript and Rust workflow schemas with config references and a default ID.
- [x] Validate IDs, paths, names, count limits, and default membership.
...
- [x] Validate changed text as UTF-8.
